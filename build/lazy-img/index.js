...
async function getImgObjFromId(imgId) {
  const media = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useSelect)(select => {
    const media = select(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.store).getMedia(imgId, {
      context: 'view'
    }); // undefined
    return media;
  }, [imgId]);
...
const v1 = {
  ...
  save: props => {
    ...
    const image = typeof calcImgSizes !== 'undefined' && typeof calcImgSizes[imgSizeIndex] !== 'undefined' ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("script", null, "document.write( '", (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("picture", {
      className: !noFigureTag ? pictureAdditionalClassName : classNames
    }, sourcesAttributesList.map((sourceAttributes, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("source", {
      ...sourceAttributes
    })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
    ...
    const aOrImage = (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, zoomable || href ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
      className: aClassName,
      ...aSaveAttributes
    }, image) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, image));
...
/* harmony import */ var _functions_attributes_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./../_functions/attributes.js */ "./src/_functions/attributes.js");
...
/* harmony import */ var _functions_img_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./../_functions/img.js */ "./src/_functions/img.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./utils */ "./src/lazy-img/utils.js");
...
async function useMigrateOnLoad(attributes, clientId, mediaSizes, portraitMediaSizes, calcImgSizes, calcPortraitImgSizes) {
  ...
  if (mediaSizes) {
    if (mediaSizes?.original) {
      ...
      let originalSizes;
      try {
        originalSizes = await (0,_functions_img_js__WEBPACK_IMPORTED_MODULE_10__.getImgWidthHeight)(sourceUrl);
      } catch (err) {
        console.error(err);
      }
    ...
    const newImgAllData = (0,_functions_img_js__WEBPACK_IMPORTED_MODULE_10__.getImgAllDataFromMediaSizes)(mediaSizes);
    ...
    const newImgData = (0,_functions_img_js__WEBPACK_IMPORTED_MODULE_10__.makeImgData)(newImgAllData.imgs, newImgAllData.truncWithoutSizeSlug, newImgAllData.fileExt);
  ...
  if (portraitMediaSizes) {
    ...
    const newPortraitImgAllData = (0,_functions_img_js__WEBPACK_IMPORTED_MODULE_10__.getImgAllDataFromMediaSizes)(portraitMediaSizes);
    ...
    const newPortraitImgData = (0,_functions_img_js__WEBPACK_IMPORTED_MODULE_10__.makeImgData)(newPortraitImgAllData.imgs, newPortraitImgAllData.truncWithoutSizeSlug, newPortraitImgAllData.fileExt);
...
function Edit({
  ...
  const hasOldAttrImgSizes = typeof imgSizes !== 'undefined' && Array.isArray(imgSizes) && imgSizes.length > 0;
  const hasOldAttrPortraitImgSizes = typeof portraitImgSizes !== 'undefined' && Array.isArray(portraitImgSizes) && portraitImgSizes.length > 0;
  const calcImgSizes = hasOldAttrImgSizes ? imgSizes : (0,_functions_img_js__WEBPACK_IMPORTED_MODULE_10__.makeImgSizesFromImgData)(imgData);
  const calcPortraitImgSizes = hasOldAttrPortraitImgSizes ? portraitImgSizes : (0,_functions_img_js__WEBPACK_IMPORTED_MODULE_10__.makeImgSizesFromImgData)(portraitImgData);
  ...
  const classNames = (0,_functions_add_class_names_js__WEBPACK_IMPORTED_MODULE_7__.addClassNames)({
    textAlign,
    marginBefore,
    marginAfter,
    marginLeft,
  ...
  // ) {
  // if ( mediaSizes || portraitMediaSizes ) {
  if (typeof mediaSizes !== 'undefined' && mediaSizes != null || typeof portraitMediaSizes !== 'undefined' && portraitMediaSizes != null) {
  ...
  async function onSelectImage(img) {
    if (typeof img.url !== 'undefined') {
      ...
      const newImgAllData = await (0,_functions_img_js__WEBPACK_IMPORTED_MODULE_10__.getImgSizesData)(img);
      const originalWidth = newImgAllData.originalWidth;
      const originalHeight = newImgAllData.originalHeight;
  ...
  async function onSelectPortraitImage(portraitImg) {
    if (typeof portraitImg.url !== 'undefined') {
      const newPortraitImgAllData = await (0,_functions_img_js__WEBPACK_IMPORTED_MODULE_10__.getImgSizesData)(portraitImg);
  ...
  if (typeof calcImgSizes !== 'undefined') {
    calcImgSizes.forEach((imgSize, index) => {
      imgSizeRadioControlOptions.push({
        ...
        label: imgSize.width + 'x' + imgSize.height + (calcImgSizes[calcImgSizes.length - 1].width !== calcImgSizes[calcImgSizes.length - 1].height && imgSize.width === imgSize.height ? ' ' + (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('(Square format)', 'bsx-blocks') : '')
      });
    });
  }
  ...
  if (typeof calcPortraitImgSizes !== 'undefined') {
    calcPortraitImgSizes.forEach((portraitImgSize, index) => {
      portraitImgSizeRadioControlOptions.push({
        value: index.toString(),
        label: portraitImgSize.width + 'x' + portraitImgSize.height + (calcPortraitImgSizes[calcPortraitImgSizes.length - 1].width !== calcPortraitImgSizes[calcPortraitImgSizes.length - 1].height && portraitImgSize.width === portraitImgSize.height ? ' ' + (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('(Square format)', 'bsx-blocks') : '')
      });
    });
  }
  ...
  const imgClassName = (0,_functions_add_class_names_js__WEBPACK_IMPORTED_MODULE_7__.addClassNames)({
    rounded,
    imgThumbnail,
    borderState
  }, 'img-fluid' + (imgAdditionalClassName ? ' ' + imgAdditionalClassName : ''));
  ...
  const srcset = (0,_utils__WEBPACK_IMPORTED_MODULE_11__.makeSrcset)({
    calcImgSizes,
    imgSizeIndex
  });
  const src = hasValidImg ? calcImgSizes[imgSizeIndex].url : '';
  ...
  const height = hasValidImg && !!displayedHeight ? displayedHeight : hasValidImg ? calcImgSizes[imgSizeIndex].height : '';
  const sizes = width && height ? '(max-width: ' + width + 'px) 100vw, ' + width + 'px' : '';
  const image = hasValidImg ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
    className: imgClassName,
    src: src,
    srcset: srcset,
    sizes: sizes,
  ...
  const controls = (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.BlockControls, null, (0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_9__.textAlignToolbar)(textAlign, onChangeTextAlign)), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Image', 'bsx-blocks')
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Alt', 'bsx-blocks'),
    value: alt,
    onChange: onChangeMediaAlt
  }), imgId ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.MediaUpload, {
    ...
    render: ({
      ...
      class: "bsxui-config-panel-img",
      src: calcImgSizes[imgSizeIndex].url,
      alt: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Change / upload image', 'bsx-blocks')
    }))
  }) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    render: ({
      ...
      onClick: open,
      isSecondary: true
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Change / upload image', 'bsx-blocks'))
    ...
    target: "_blank"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Preview selected image', 'bsx-blocks')))), imgId && typeof calcImgSizes !== 'undefined' && typeof calcImgSizes[imgSizeIndex] !== 'undefined' && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Displayed width', 'bsx-blocks'),
    value: !!displayedWidth ? displayedWidth : calcImgSizes[imgSizeIndex].width,
    onChange: onChangeDisplayedWidth
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Displayed height', 'bsx-blocks'),
    value: !!displayedHeight ? displayedHeight : calcImgSizes[imgSizeIndex].height,
    onChange: onChangeDisplayedHeight
  }), (0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_9__.scaleSelect)(scale, onChangeScale)), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.SelectControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Rounded', 'bsx-blocks'),
    value: rounded,
    ...
    options: [{
      ...
      value: 'rounded',
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Rounded corners', 'bsx-blocks')
    }, {
      value: 'circle',
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Circle', 'bsx-blocks')
    }]
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Portrait image (optional)', 'bsx-blocks')
  }, !!zoomable ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "bsxui-config-panel-row"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "bsxui-alert"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Portrait image is deactivated since Zoomable image is set.', 'bsx-blocks'))) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, portraitImgId && typeof calcPortraitImgSizes[portraitImgSizeIndex] != 'undefined' && typeof calcPortraitImgSizes[portraitImgSizeIndex].url != 'undefined' ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.MediaUpload, {
    ...
    render: ({
      ...
      alt: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Change / upload portrait image', 'bsx-blocks')
    }))
  }) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "bsxui-config-panel-row"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    render: ({
      ...
      onClick: open,
      isSecondary: true
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Change / upload portrait image', 'bsx-blocks'))
  })), portraitImgId && typeof calcPortraitImgSizes[portraitImgSizeIndex] != 'undefined' && typeof calcPortraitImgSizes[portraitImgSizeIndex].url != 'undefined' && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "bsxui-config-panel-row"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Button, {
  ...
  }), typeof calcPortraitImgSizes != 'undefined' && typeof calcPortraitImgSizes[portraitImgSizeIndex] != 'undefined' && typeof calcPortraitImgSizes[portraitImgSizeIndex].url != 'undefined' && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "bsxui-config-panel-text"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    class: "bsxui-link",
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Zoomable (optional)', 'bsx-blocks')
  }, calcPortraitImgSizes.length > 0 || !!href ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "bsxui-config-panel-row"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "bsxui-alert"
  }, !!href ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Zoomable image is deactivated since href is set.', 'bsx-blocks') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Zoomable image is deactivated since Portrait image is set.', 'bsx-blocks'))) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToggleControl, {
    className: calcPortraitImgSizes.length > 0 || !!noFigureTag ? 'bsxui-disabled' : '',
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Zoomable image', 'bsx-blocks'),
    checked: !!zoomable,
    onChange: onChangeZoomable,
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('If enabled click on image will open shadowbox gallery with large image.', 'bsx-blocks')
  }), zoomable ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.RadioControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Zoom image size', 'bsx-blocks'),
    selected: zoomImgSizeIndex,
    options: zoomImgSizeRadioControlOptions,
    onChange: onChangeZoomImgSizeIndex
  }), imgSizeIndex == zoomImgSizeIndex && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "bsxui-config-panel-text"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Currently your zoom image is not larger than your original image.', 'bsx-blocks')), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToggleControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('External gallery parent', 'bsx-blocks'),
    checked: !!externalGalleryParent,
    onChange: onChangeExternalGalleryParent,
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Enabled if using custom external shadowbox gallery element (e.g. configured BSX Wrapper) wrapping this image.', 'bsx-blocks')
  })) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "bsxui-config-panel-row"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "bsxui-alert"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Zoomable image is deactivated since No figure Tag is set.', 'bsx-blocks'))))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Link (optional)', 'bsx-blocks')
  }, !!zoomable ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "bsxui-config-panel-row"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "bsxui-alert"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Link is deactivated since <i>Zoomable image</i> is set.', 'bsx-blocks'))) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_9__.linkUrlInput)(href, onChangeHref), (0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_9__.targetToggle)(target, onChangeTarget), (0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_9__.relInput)(rel, onChangeRel))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Margin', 'bsx-blocks')
  }, (0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_9__.marginLeftSelect)(marginLeft, onChangeMarginLeft), (0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_9__.marginRightSelect)(marginRight, onChangeMarginRight), (0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_9__.marginBeforeSelect)(marginBefore, onChangeMarginBefore), (0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_9__.marginAfterSelect)(marginAfter, onChangeMarginAfter))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorAdvancedControls, null, (0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_9__.disableResponsiveDownsizingToggle)(disableResponsiveDownsizing, onChangeDisableResponsiveDownsizing), (0,_functions_controls_js__WEBPACK_IMPORTED_MODULE_9__.portraitImgMaxWidthBreakpointInput)(portraitImgMaxWidthBreakpoint, onChangePortraitImgMaxWidthBreakpoint), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToggleControl, {
    className: !!zoomable ? 'bsxui-disabled' : '',
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('No figure tag', 'bsx-blocks'),
    checked: !!noFigureTag,
    ...
    class: "bsxui-alert"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Figure tag must exist since Zoomable image is set.', 'bsx-blocks'))), !!href && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('A element additional class(es)', 'bsx-blocks'),
    value: aAdditionalClassName,
    onChange: onChangeAAdditionalClassName
  }), !noFigureTag ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Picture element additional class(es) – DEPRECATED', 'bsx-blocks'),
    ...
    class: "bsxui-alert"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Picture element additional class(es) is deactivated since No figure tag is set. Use Additional class(es) instead.', 'bsx-blocks'), ".")), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Image element additional class(es)', 'bsx-blocks'),
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("figure", {
    ...blockProps
  }, imgId ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, !zoomable ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, image) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    ...
    render: ({
      ...
      onClick: open,
      isSecondary: true
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Select / upload Image', 'bsx-blocks'))
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
    tagName: "figcaption",
    multiline: false,
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Caption (optional)', 'bsx-blocks'),
    value: figcaption,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.withSelect)((select, props) => {
  ...
  const hasDeprecatedAttrImgSizes = typeof imgSizes !== 'undefined' && Array.isArray(imgSizes) && imgSizes.length > 0 && (typeof imgData === 'undefined' || imgData.length === 0) && !!imgId;
  const hasDeprecatedAttrPortraitImgSizes = typeof portraitImgSizes !== 'undefined' && Array.isArray(portraitImgSizes) && portraitImgSizes.length > 0 && (typeof portraitImgData === 'undefined' || portraitImgData.length === 0) && !!portraitImgId;
  const hasMissingSize768 = typeof imgData !== 'undefined' && Array.isArray(imgData) && imgData.length > 0 && typeof imgData[0] !== 'undefined' && typeof imgData[0].sizes !== 'undefined' && typeof imgData[0].sizes[imgData[0].sizes.length - 1].w !== 'undefined' && parseInt(imgData[0].sizes[imgData[0].sizes.length - 1].w) <= 1024 && parseInt(imgData[0].sizes[imgData[0].sizes.length - 1].w) >= 780 && parseInt(imgData[0].sizes[imgData[0].sizes.length - 2].w) !== 768;
  ...
  if (hasDeprecatedAttrImgSizes || hasMissingSize768) {
    ...
    if (typeof media !== 'undefined' && typeof originalImage !== 'undefined') {
      ...
      const originalImgSize = {
        original: {
          file: originalImage,
          // media?.media_details?.original_image,
          width: null,
          // is not defined in media object
          height: null,
          // is not defined in media object
          filesize: media?.media_details?.filesize,
          mime_type: media?.mime_type,
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils */ "./src/lazy-img/utils.js");
...
function save({
  ...
  const classNames = (0,_functions_add_class_names_js__WEBPACK_IMPORTED_MODULE_2__.addClassNames)({
    textAlign,
    marginBefore,
    marginAfter,
    marginLeft,
  ...
  const imgClassName = (0,_functions_add_class_names_js__WEBPACK_IMPORTED_MODULE_2__.addClassNames)({
    rounded,
    imgThumbnail,
    borderState
  }, 'img-fluid' + (imgAdditionalClassName ? ' ' + imgAdditionalClassName : ''));
  ...
  // allow zoomable img
  const saveAttributes = zoomable && !externalGalleryParent ? (0,_functions_attributes_js__WEBPACK_IMPORTED_MODULE_3__.makeSaveAttributes)({
    'data-fn': 'photoswipe'
  }) : {};

  // manage zoomImgSizeIndex & href, target, rel
  const aSaveAttributes = zoomable && typeof calcImgSizes[zoomImgSizeIndex] != 'undefined' ? (0,_functions_attributes_js__WEBPACK_IMPORTED_MODULE_3__.makeSaveAttributes)({
    'href': calcImgSizes[zoomImgSizeIndex].url,
    'data-size': calcImgSizes[zoomImgSizeIndex].width + 'x' + calcImgSizes[zoomImgSizeIndex].height
  }) : !!href ? {
    'href': href,
  ...
  const image = hasValidImg ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("script", null, "document.write( '", (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
    className: landscapeImgClassName,
    src: (0,_functions_img_js__WEBPACK_IMPORTED_MODULE_4__.makeBase64PreloadImgSrc)(width, height),
    "data-src": src,
    "data-srcset": srcset,
    sizes: sizes,
    alt: alt,
  ...
  let portraitImage = (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null);
  if (hasValidPortraitImg) {
    const portraitSrcset = (0,_utils__WEBPACK_IMPORTED_MODULE_5__.makeSrcset)({
      calcImgSizes: calcPortraitImgSizes,
      imgSizeIndex: portraitImgSizeIndex
    });
    const portraitSrc = calcPortraitImgSizes[portraitImgSizeIndex].url;
    ...
    portraitImage = (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("script", null, "document.write( '", (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
      className: portraitImgClassName,
      src: (0,_functions_img_js__WEBPACK_IMPORTED_MODULE_4__.makeBase64PreloadImgSrc)(portraitWidth, portraitHeight),
      "data-src": portraitSrc,
      "data-srcset": portraitSrcset,
      sizes: portaitSizes,
      alt: alt,
...
const makeSourcesAttributesList = attributes => {
  ...
  responsiveMediaIndexList.forEach((item, index) => {
    ...
    if (!disableResponsiveDownsizing && adaptedCurrentImgIndex < parseInt(imgSizeIndex) && adaptedCurrentImgIndex > skipIndex && typeof calcImgSizes != 'undefined' && typeof calcImgSizes[adaptedCurrentImgIndex] != 'undefined' && typeof calcImgSizes[adaptedCurrentImgIndex].url != 'undefined') {
      sourcesAttributesList.push({
        media: '(max-width: ' + (parseInt(item.breakpoint) - 0.02) + 'px)',
        srcset: (0,_functions_img_js__WEBPACK_IMPORTED_MODULE_0__.makeBase64PreloadImgSrc)(calcImgSizes[adaptedCurrentImgIndex].width, calcImgSizes[adaptedCurrentImgIndex].height),
        'data-srcset': calcImgSizes[adaptedCurrentImgIndex].url,
        'data-width': calcImgSizes[adaptedCurrentImgIndex].width,
        'data-height': calcImgSizes[adaptedCurrentImgIndex].height
      });
...
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/lazy-img/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/lazy-img/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/lazy-img/block.json");
/* harmony import */ var _deprecated__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./deprecated */ "./src/lazy-img/deprecated.js");
/**
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  icon: _functions_icon__WEBPACK_IMPORTED_MODULE_1__.lazyImg,
